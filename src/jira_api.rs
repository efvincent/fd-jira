...
pub fn get_changed_issues_do(creds:&Creds, base_url: &str, startAt:usize) -> IssueSearchResultSet {
    let query = make_query("RCTFD", &DateTime::parse_from_rfc3339("2019-09-01T00:00:00-05:00").unwrap());
